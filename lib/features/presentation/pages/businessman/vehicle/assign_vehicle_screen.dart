  ...
  Future<void> _createVehicle() async {
    if (_formKey.currentState!.validate()) {
      final vehicle = VehicleModel(
        ...
        serialNumber: '55616', // Valor fijo o usa un controlador si es dinámico
        idPropietario: 1, // Cambié ownerId a idPropietario para coincidir con tu modelo
        idTransportista: 1, // Cambié carrierId a idTransportista para coincidir con tu modelo
      );      try {
        // Crear el vehículo - si hay un error, se capturará en el bloque catch
        await vehicleService.createVehicle(vehicle);
        
        // Si llegamos hasta aquí, significa que la operación fue exitosa
        // Notificar al callback sobre el vehículo añadido
